...
33. Работа со списками (добавить, удалить, найти определенный, етс.) в ansible?

34. Как, по какому критерию выбрать балансировщик из haproxy, httpd, nginx?

## Тестовые задания

34. Есть две изолированные сети /25 - 192.168.1.0 (gw: 192.168.1.1), 192.168.1.128 (gw: 192.168.1.129).
...
38. Необходимо проходить по списку URL'ов и проверять, что они все "живые".
