...
38. Задание ozon.ru, временное ограничение 20 мин.
```
Нужно проходить по списку URL'ов и проверять, что они все "живые".
...
- Вчера в 2Гис тех.собес был - я дно :( Завалил. GIL, мультипроцессорность, асинхронщина, даже проблему колизий в словарях -забыл/не знал... Самое что обидное, в одном подтянешь, а на другом собесе будет все другое (код на скорость писать например), и снова завалишь.
