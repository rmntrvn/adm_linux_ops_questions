...
16. Где хранятся имена файлов/директорий?
<details>
  <summary>Ответ</summary>
...
17. Как удалить файл с именем `-rf`?
...
18. Как посмотреть описание дискриптора? Как посмотреть время последней модификации файла?
...
19. Для чего нужна переменная окружения PATH?
...
8. Что находится внутри master ноды?

9. Как установить Kubernetes?

10. Чем отличается StatefulSet от Depployment?

11. Что такое операторы?

12. Почему DaemonSet не нужен scheduler?

13. В каких случаях не отработает перенос пода на другую ноду?

14. Что делает ControllerManager?

15. Администратор выполняет команду `kubectl apply -f deployment.yaml`. Опишите по порядку что происходит в каждом из узлов Kubernetes и в каком порядке.

16. Как выполнить обновление Kubernetes в контуре где нет интернета?

17. Чем Router в Openshift отличается от Ingress в Kubernetes?



## Неотсортированное

19. Как посмотреть нагрузку на диски?
20. Клиент тебе пишет, что заходит на свой сайт и он к нему подключается через раз. Что делать, что спрашивать от клиента? Тут короче спрашивали про анализ сети - traceroute, mtr
21. Что такое RoundRobin DNS как работает? Какие записи бывают? Что такое DKIM, DMARC, PTR?
22. Что такое buffer/cache память? Для чего нужна?
23. Какие бест практисы для написания dockerfile docker-compose может рассказать?
24. Что такое 127.0.0.1 адрес? Для чего нужен?
25. Какими файрволами работал? Какие у iptables есть цепочки и таблицы и для чего нужны? Как сделать NAT?
26. Как настроить master slave репликацию в mysql?
...
- Что такое сигнал в Unix, зачем они нужны, разница между 9 и 15 сигналами?
...
- какие состояния процессов вы знаете, почитайте про большую букву D
- что такое зомби процесс, можно ли самостоятельно сделать зомби?
